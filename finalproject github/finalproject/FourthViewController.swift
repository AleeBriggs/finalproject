...
class FourthViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func goToArticle(_ sender: Any) {
        if let url = URL(string: "https://variety.com/2019/tv/news/octavia-spencer-production-company-20th-fox-tv-deal-1203200095/") {
    ...
    @IBAction func addPost(_ sender: Any) {
        ...
        ref?.child("Pop Culture").childByAutoId().setValue(textView.text)
    ...
    override func viewDidLoad() {
        ...
        databaseHandle =
            ref?.child("Pop Culture").observe(.childAdded, with: { (snapshot) in
